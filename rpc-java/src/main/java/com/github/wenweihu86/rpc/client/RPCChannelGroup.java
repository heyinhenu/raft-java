...
public class RPCChannelGroup {
        ...
        future.addListener(new ChannelFutureListener() {
            ...
            public void operationComplete(ChannelFuture channelFuture) throws Exception {
                if (channelFuture.isSuccess()) {
                    LOG.info("connect to {}:{} success, channel={}", ip, port, channelFuture.channel());
                } else {
                    LOG.warn("future callback, connect to {}:{} failed due to {}", ip, port,
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && RPCChannelGroup.class.isAssignableFrom(obj.getClass())) {
            ...
            flag = new EqualsBuilder().append(ip, f.getIp()).append(port, f.getPort()).isEquals();
        }
        return flag;
    }
