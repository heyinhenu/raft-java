...
public class WorkThreadPool {
    ...
    public WorkThreadPool(int workThreadNum) {
        executor = new ThreadPoolExecutor(workThreadNum, workThreadNum, 60L, TimeUnit.SECONDS, blockingQueue,
    ...
    public static class WorkTask implements Runnable {
        ...
        public WorkTask(ChannelHandlerContext ctx, Object fullRequest) {
