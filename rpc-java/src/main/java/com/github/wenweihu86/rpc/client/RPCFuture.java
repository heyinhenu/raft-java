...
public class RPCFuture<T> implements Future<Object> {
    ...
    public RPCFuture(ScheduledFuture scheduledFuture, Long callId, Object fullRequest, Class<T> responseClass,
            RPCCallback<T> callback, RPCChannelGroup channelGroup) {
        this.callId = callId;
