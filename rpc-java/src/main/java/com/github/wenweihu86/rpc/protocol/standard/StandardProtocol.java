...
public class StandardProtocol<T> implements ProtocolProcessor {
    ...
    @Override
    public boolean decodeRequest(ChannelHandlerContext ctx, ByteBuf in, List<Object> out) {
    ...
    public Object processRequest(Object request) {
        ...
        // default response
        RPCHeader.ResponseHeader.Builder responseHeader = RPCHeader.ResponseHeader.newBuilder().setCallId(
                fullRequest.getHeader().getCallId()).setResCode(RPCHeader.ResCode.RES_FAIL);
        ...
        try {
            ...
            MessageLite responseMessage = (MessageLite) serviceInfo.getMethod().invoke(serviceInfo.getService(),
                    requestMessage);
            ...
            LOG.debug("elapseMS={} service={} method={} callId={}", endTime - startTime, requestHeader.getServiceName(),
    ...
    private boolean decode(boolean isRequest, ChannelHandlerContext ctx, ByteBuf in, List<Object> out) {
